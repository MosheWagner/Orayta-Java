...
public class DafYomiBookmarkGenerator implements IBookmarkBuilder 
{
	...
	private static final List <Integer> MASEHTOT_UID = Arrays.asList(841,844,847,908,850,853,875,859,1106,888,862,892,1136,868,920,895,903,928,934,899,997,959,948,1003,1007,1014,1022,1027,1030,1040,1045,1132,1060,1035,1121,1117,1056);
	private static final List <Integer> DAPIM = Arrays.asList(64,157,105,121,22,88,56,40,35,31,32,29,27,/*Yevamot*/122,112,91,66,49,90,82,/*Bava Kama*/119,119,176,113,24,49,76,14,/*Zevahim*/120,110,142,61,34,34,28,37,73 );
	...
	private int[] masechetAndDafFromDate(Date d)
	{
	    ...
	    masechetID = MASEHTOT_UID.get(masechetIndex);
